...
def test_db_exists(db_path):
    ...
    assert db_path.is_file(), f'No such Database at path: {db_path}'
...
def test_employee_table_exists(table_names):
    ...
    assert 'employee' in table_names, 'String "employee" is not part of table_names'
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'team' in table_names, 'String "team" is not part of table_names'
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    assert 'employee_events' in table_names, 'String "employee_events" is not part of table_names'
