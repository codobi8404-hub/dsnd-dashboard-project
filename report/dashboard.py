...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        df_pd = model.event_counts(entity_id)
        ...
        df_pd_index_column = df_pd.set_index("event_date")
        
        # Sort the index
        df_sorted = df_pd_index_column.sort_index()
        
        # Use the .cumsum method to change the data
        # in the dataframe to cumulative counts
        df_cumsum = df_sorted.cumsum()
        ...
        self.set_axis_styling(ax=ax, bordercolor='k', fontcolor='k')
        
        # Set title and labels for x and y axis
        ax.set_title(f"Events for ({model.name} & {entity_id})")
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        probability = self.predictor.predict_proba(ml_data)
