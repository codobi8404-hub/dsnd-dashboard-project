...
from employee_events.query_base import QueryBase, Employee, Team
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, model, asset_id):
        ...
        if model.name == "Team":
            pred = proba_positive_class.mean()

        # Otherwise set `pred` to the first value
        # of the predict_proba output
        else:
            pred = proba_positive_class[0]
...
def get_employee_report(id: str):
